...
public class DrawPanel extends JPanel implements Runnable{
    ...
    public void drawline(Graphics g,int n){
        ...
        g.drawString("ʱ������ο�", 500, 20);
        g.drawString("��ɫԲ��Ϊ���", 500, 40);
        if(p){
            g.drawString("��ǰ�ܾ���:"+s, 0,520);
            s=String.valueOf(df.format(distance_min));
            g.drawString("��ǰ��̾���:"+s, 450, 520);
            Time_total=(System.currentTimeMillis()-Time_start);
            s=String.valueOf(Time_total);
            g.drawString("����ʱ:"+s+"����", 250, 520);
        }
        else{
            g.drawString("��̾���:"+s, 150,520);
            s=String.valueOf(Time_total);
            g.drawString("����ʱ:"+s+"����",350, 520);
